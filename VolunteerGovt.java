...
public class VolunteerGovt extends Activity  implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_volunteer_govt);
		...
		db.execSQL("create table if not exists govt(issue varchar,solution varchar);");	
	}
	 public void onClick(View view)
	    {
	    	...
	    	if(view==add)
	    	{
	    		...
	    		db.execSQL("INSERT INTO govt VALUES('"+issue.getText()+"','"+solution.getText()+"');");
	    	...
	    	if(view==delete)
	    	{
	    		...
	    		Cursor c=db.rawQuery("SELECT * FROM govt WHERE issue='"+issue.getText()+"'", null);
	    		if(c.moveToFirst())
	    		{
	    			db.execSQL("DELETE FROM govt WHERE issue='"+issue.getText()+"'");
	    	...
	    	if(view==viewy)
	    	{
	    		...
	    		Cursor c=db.rawQuery("SELECT * FROM govt", null);
	    		if(c.getCount()==0)
	    		{
