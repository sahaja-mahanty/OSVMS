...
public class VolunteerEducation extends Activity  implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_volunteer_education);
		...
		db.execSQL("create table if not exists edu(issue varchar,solution varchar);");	
	}
	 public void onClick(View view)
	    {
	    	...
	    	if(view==add)
	    	{
	    		...
	    		db.execSQL("INSERT INTO edu VALUES('"+issue.getText()+"','"+solution.getText()+"');");
	    	...
	    	if(view==delete)
	    	{
	    		...
	    		Cursor c=db.rawQuery("SELECT * FROM edu WHERE issue='"+issue.getText()+"'", null);
	    		if(c.moveToFirst())
	    		{
	    			db.execSQL("DELETE FROM edu WHERE issue='"+issue.getText()+"'");
	    	...
	    	if(view==viewy)
	    	{
	    		...
	    		Cursor c=db.rawQuery("SELECT * FROM edu", null);
	    		if(c.getCount()==0)
	    		{
