...
public class VolunteerTransportation extends Activity  implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_volunteer_transportation);
		...
		db.execSQL("create table if not exists transport(issue varchar,solution varchar);");	
	}
	 public void onClick(View view)
	    {
	    	...
	    	if(view==add)
	    	{
	    		...
	    		db.execSQL("INSERT INTO transport VALUES('"+issue.getText()+"','"+solution.getText()+"');");
	    	...
	    	if(view==delete)
	    	{
	    		...
	    		if(c.moveToFirst())
	    		{
	    			db.execSQL("DELETE FROM transport WHERE issue='"+issue.getText()+"'");
